...
class BiodataClass extends Component {
  constructor(props) {
    super(props);
    this.state = {
      MyBio: {
  ...
  render() {
    const { identity, instansi, jurusan, kelas, mobile_phone, email, gender } = this.state.MyBio;

    return (
      <View>
        <Text style={styles.header}>Data Diri (RCC)</Text>
